...
your otp is invalid
<br><br>
payment has not been processed <i class="fa fa-times-circle" style="font-size:36px; color:red;"></i>
<br><br>
Sorry, for the inconvenience
<br><br>
<button class="btn"><a href="payment.php">Click to start payment</button>
<br>
</p>
    </center>
</div>
